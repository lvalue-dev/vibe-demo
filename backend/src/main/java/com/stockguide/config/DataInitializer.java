    ...
    public ApplicationRunner initStocks() {
        return args -> {
            List<Stock> stocks = List.of(
                    ...
                    Stock.builder().symbol("950130.KQ").name("엑스페릭스").market("KOSDAQ").sector("반도체소재").build(),
                    ...
                    Stock.builder().symbol("036030.KQ").name("고려제강").market("KOSDAQ").sector("철강").build(),
                    ...
                    // 바이오/헬스케어
                    Stock.builder().symbol("207940.KQ").name("삼성바이오에피스").market("KOSDAQ").sector("바이오").build(),
                    ...
                    // IT/플랫폼
                    Stock.builder().symbol("950050.KQ").name("WCP").market("KOSDAQ").sector("IT서비스").build(),
                    Stock.builder().symbol("041830.KQ").name("인바디").market("KOSDAQ").sector("의료기기").build(),
                    ...
                    Stock.builder().symbol("035760.KQ").name("CJ ENM").market("KOSDAQ").sector("미디어·콘텐츠").build(),
                    ...
                    // EV/2차전지
                    Stock.builder().symbol("298040.KQ").name("효성중공업").market("KOSDAQ").sector("전기기기").build(),
